...
struct mat33
{
    ...
    __host__ __device__ float determine() const
    {
        float d = m00() * m11() * m22() - m00() * m12() * m21() - m01() * m10() * m22() + m01() * m12() * m20() + m02() * m10() * m21() - m02() * m11() * m20();
        return d;
    }
...
struct mat34
{
    ...
    __host__ __device__ mat34 operator+(const mat34 &_T) const
    {
        ...
        se3.rot.m00() += _T.rot.m00();
        se3.rot.m01() += _T.rot.m01();
        se3.rot.m02() += _T.rot.m02();
        se3.rot.m10() += _T.rot.m10();
        se3.rot.m11() += _T.rot.m11();
        se3.rot.m12() += _T.rot.m12();
        se3.rot.m20() += _T.rot.m20();
        se3.rot.m21() += _T.rot.m21();
        se3.rot.m22() += _T.rot.m22();

        se3.trans.x += _T.trans.x;
        se3.trans.y += _T.trans.y;
        se3.trans.z += _T.trans.z;
